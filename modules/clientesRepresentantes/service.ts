...
export async function createClienteRepresentante(data: clienteRepresentanteDTO) {
...
export async function updateClienteRepresentante(id: string, data: clienteRepresentanteDTO) {
    const result = clienteRepresentanteDTO.parse(data);
